...
if (!requireNamespace("TDSAMeta", quietly = TRUE)) {install.packages("TDSAMeta")}; require("TDSAMeta",quietly = TRUE)
...
if (!requireNamespace("readxl", quietly = TRUE)) {install.packages("readxl")}; require("readxl",quietly = TRUE)

source('../11DTA-Meta/ui_tab.R')
source("../tab/panel.R")
source("../tab/func.R")
...
tabPanel("TDSA",
headerPanel("Time Dependent Sensitivity Analysis"),
source("ui_tdsa.R",local=TRUE)$value
),
