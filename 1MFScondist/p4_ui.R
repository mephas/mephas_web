...
"0.11\n0.57\n0.59\n0.52\n0.13\n0.45\n0.63\n0.68\n0.44\n0.55\n0.48\n0.54\n0.29\n0.41\n0.64\n0.75\n0.33\n0.24\n0.45\n0.18"				        ),
	...
	mainPanel(
		...
		tabsetPanel(
			 tabPanel("Mathematical-based Plot", p(br()),
				...
				plotOutput("b.plot", click = "plot_click13", width = "1000px", height = "400px"),
			 ...
			 tabPanel("Simulation-based Plot", p(br()),
				...
				plotOutput("b.plot2", click = "plot_click14", width = "1000px", height = "400px"),
   ...
   <ul>
    ...
    "
			...
			plotOutput("makeplot.b", width = "1000px", height = "400px"),
