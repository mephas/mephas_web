...
tabPanel.checktab("含有合计的RxC列联表", "dt5", "dt5.0"),
tabPanel.perctab("dt5.1","dt5.2","dt5.3"),
tabPanel.countplot1("makeplot5")
...
conditionalPanel(
condition = "input.explain_on_off",
p(tags$i("此默认设置得出结论:药物治疗和反应之间存在统计学显著的关系。（P值 < 0.001）"))
)
