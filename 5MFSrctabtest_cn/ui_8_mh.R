...
choiceNames = list(
HTML("病例对照（行）与分组因子（列）显著相关；各分层的优势比（Odds Ratio，OR值）没有显著差异"),
HTML("第1层的优势比高于第2层（OR值>1）"),
HTML("第2层的优势比高于第1层（OR值<1）")
),
...
<b> 说明 </b> 
<ul> 
<li> P值 < 0.05，则在个人吸烟得到控制的情况下，二手烟与患癌症的风险之间存在显着的关系，优势比（OR值）有显著不同。（接受备择假设）
