...
numericInput("td1", "Component at x-axis", 1, min = 1, max = NA),
numericInput("td2", "Component at y-axis", 2, min = 1, max = NA),
numericInput("td3", "Component at z-axis", 3, min = 1, max = NA),
p("x y z must be different"),
numericInput("lines", "Change line scale (length)", 10, min = 1, max = NA)
),
