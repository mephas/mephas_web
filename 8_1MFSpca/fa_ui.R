...
numericInput("td1.fa", "1. Component at x-axis", 1, min = 1, max = NA),
numericInput("td2.fa", "2. Component at y-axis", 2, min = 1, max = NA),
numericInput("td3.fa", "3. Component at z-axis", 3, min = 1, max = NA),
