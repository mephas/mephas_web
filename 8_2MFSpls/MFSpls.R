...
<li> To get the factors and loadings distribution plots in 2D 
...
actionButton("B.pls", h4(tags$b("Show Prediction >>")), class = "btn btn-primary")
...
score <- score()
load <- load()
plot_biplot(score, load, input$c11, input$c22)
...
output$pls.bp   <- renderPlot({ 
  ...
  score <- score.r()
load <- load.r()
plot_biplot(score, load, input$c11.r, input$c22.r)
...
score <- score.s()
load <- load.s()
plot_biplot(score, load, input$c11.s, input$c22.s)
