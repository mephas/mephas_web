...
numericInput("nc", "3. How many new components? (A <= dimension of X)", 3, min = 1, max = NA),
...
radioButtons("val", "4. Do cross-validation?",
...
conditionalPanel(
condition = "input.explain_on_off",
p(tags$i("In this plot, we plot the scatter points of component1 and component2, and found 327, 332 were the outliers."))
),
