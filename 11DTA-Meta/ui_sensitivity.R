sidebarLayout(
   ...
   mainPanel(
    	    tabsetPanel(id="Sensitivity_Panel",
                           tabPanel("SROC",
                                    fluidRow(column(width = 6,HTML("<h4>c<sub>1</sub>c<sub>2</sub>estimate"),downloadButton("downloadsauc_gg_estimate","Save Image"),
                                                    plotOutput("srocB")
                                    ...
                                    ,column(width = 6,HTML("<h4>c<sub>1</sub>c<sub>2</sub>","c<sub>1</sub>=1,c<sub>2</sub>=0"),downloadButton("download_srocC_10","Save Image"),
                                            plotOutput("srocC_10")#,flowLayout(ui.plot_baseset_drop("c1c2_10"),uiOutput("srocCsetting_curve_10"))
                                            )
                                    ,column(width = 6,HTML("<h4>c<sub>1</sub>c<sub>2</sub>","c<sub>1</sub>=0,c<sub>2</sub>=1"),downloadButton("download_srocC_01","Save Image"),
                                            plotOutput("srocC_01")#,flowLayout(ui.plot_baseset_drop("c1c2_01"),uiOutput("srocCsetting_curve_01"))
                                            )
                                    ,column(width = 6,HTML("<h4>c<sub>1</sub>c<sub>2</sub>","Manual set"),downloadButton("download_c1c2_manul","Save Image"),
