...
#validate(need(length(p.seq())>0,"Input marginal selection probabilities is missing."))
  ...
  #              {
                ...
                try(SROC(est2.par, addon  = TRUE, sroc.type = sroc.type,sp.pch = 20,sp.cex=2.5))            
                 legend("bottomright",
                        bty='n',
                 ...
                 plot(1-sp(), se(), type = "p", ylim = c(0,1), xlim = c(0,1), 
                      xlab = "",
                      yaxt = "n")
                 try(SROC(est11.par, addon = TRUE,sroc.type =  sroc.type,sp.pch = 20,sp.cex=2.5))
                 legend("bottomright", 
                        bty='n',
                 ...
                 plot(1-sp(), se(), type = "p", ylim = c(0,1), xlim = c(0,1), 
                      xlab = "",
                      ylab = "")
                 try(SROC(est10.par, addon = TRUE, sroc.type = sroc.type,sp.pch = 20,sp.cex=2.5))
                 legend("bottomright", 
                        bty='n',
                 ...
                 try(SROC(est01.par, addon = TRUE, sroc.type = sroc.type,sp.pch = 20,sp.cex=2.5))
                 legend("bottomright", 
                        bty='n',
