...
output$norm.plot <- renderPlot({
  ...
  ylab("密度") + theme_bw()  + ylim(0, input$ylim) +
...
{df = N()
ggplot(df, aes(x = x)) + theme_bw() + ylab("頻度")+ geom_histogram(binwidth = input$bin, colour = "white", fill = "cornflowerblue", size = 0.1) + 
...
output$t.plot <- renderPlot({
  ...
  ylab("密度") + scale_y_continuous(breaks = NULL) + theme_minimal() + ylim(0, input$t.ylim) + 
...
output$x.plot <- renderPlot({
  ...
  stat_function(fun = dchisq, n = 100, args = list(df = input$x.df)) + ylab("密度") +
...
{df = X()
ggplot(df, aes(x = x)) + theme_bw() + ylab("頻度")+ geom_histogram(binwidth = input$x.bin, colour = "white", fill = "cornflowerblue", size = 0.1) + 
...
output$f.plot <- renderPlot({
  ...
  stat_function(fun = "df", n= 100, args = list(df1 = input$df11, df2 = input$df21)) + ylab("密度") +
...
{df = F()
ggplot(df, aes(x = x)) + theme_bw() + ylab("頻度")+ geom_histogram(binwidth = input$f.bin, colour = "white", fill = "cornflowerblue", size = 0.1) + 
...
output$e.plot <- renderPlot({
  ...
  stat_function(fun = "dexp", args = list(rate = input$r)) + ylab("密度") +
...
{df = E()
ggplot(df, aes(x = x)) + theme_bw() + ylab("頻度")+ geom_histogram(binwidth = input$e.bin, colour = "white", fill = "cornflowerblue", size = 0.1) + 
...
output$g.plot <- renderPlot({
  ...
  stat_function(fun = "dgamma", args = list(shape = input$g.shape, scale=input$g.scale)) + ylab("密度") +
...
{df = G()
ggplot(df, aes(x = x)) + theme_bw() + ylab("頻度")+ geom_histogram(binwidth = input$g.bin, colour = "white", fill = "cornflowerblue", size = 0.1) + 
