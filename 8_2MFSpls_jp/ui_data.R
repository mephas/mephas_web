...
p(br()),
actionButton("ModelPCR","PCRモデルへ >>",class="btn btn-primary",icon("location-arrow")),p(br()),
actionButton("ModelPLSR","PLSRモデルへ >>",class="btn btn-primary",icon("location-arrow")),p(br()),
actionButton("ModelSPLSR","SPLSRモデルへ >>",class="btn btn-primary",icon("location-arrow")),p(br()),
hr()
