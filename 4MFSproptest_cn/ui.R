...
<h4><i>示例</i></h4>
<i>假设在一般人群中有20%的不孕妇女。假设一种治疗可能会影响不孕。200名尝试怀孕的妇女接受了这种治疗。在40名接受治疗的妇女中，仍有10人不孕。想知道接受治疗妇女的不孕率与一般不孕率的20%相比是否有显著性差异。 
</h4></i>
...
<h4><i>示例</i></h4>
<i>假设我们想研究第一次生育年龄与乳腺癌发展之间的关系。因此，我们调查了3220例乳腺癌患者和10254例非乳腺癌患者。然后，我们将妇女分为不同的年龄组。我们想知道不同年龄组患癌症的概率是否不同；或者她们的年龄是否与乳腺癌有关。
</i>
<h4>请按照以下<b>步骤</b>，<b>输出</b>实时分析结果。</h4>   
"
)
