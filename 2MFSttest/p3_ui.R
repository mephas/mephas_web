...
sidebarLayout(
      ...
      mainPanel(
        ...
        tabsetPanel(
          ...
          tabPanel("Data display", p(br()),  dataTableOutput("table.p")),
          ...
          tabPanel("Mean and SD plot", p(br()), plotOutput("meanp.p", width = "400px", height = "400px")),

          tabPanel("Plots of normality", p(br()), plotOutput("makeplot.p", width = "900px", height = "300px"),
