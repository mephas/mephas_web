...
sidebarLayout(
  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel("Mean and SD plot", p(br()), plotOutput("meanp2", width = "400px", height = "400px")),

      tabPanel("Plots of normality", p(br()), plotOutput("makeplot2", width = "600px", height = "600px"),
