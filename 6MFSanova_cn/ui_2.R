...
plotly::plotlyOutput("meanp.a", width = 500)
),
...
plotly::plotlyOutput("mmean.a", width = 500)
)
),
...
<li> DF<sub>相互作用</sub> = DF<sub>因子1</sub> x DF<sub>因子2</sub>
<li> DF<sub>残差</sub> = 样本值的个数 - 因子组1的类别数 x 因子组2的类别数
<li> MS = SS/DF
