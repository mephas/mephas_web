...
hr(),
  ...
  p(tags$i("在此示例中，我想知道六个吸烟组中的哪个对具有不同的FEF值。"))
  ),
hr(),
  h4(tags$b("第2步 选择多重比较方法")),
  radioButtons("method", 
  "用哪种方法？见下面解释", selected="BH",
  choiceNames = list(
    HTML("Bonferroni法"),
...
hr(),
  ...
  "<b> 说明 </b>
    ...
    <li> Benjamini和Hochberg开发的<b>错误发现率-BH</b>比其他方法功能更强大。</li>
    <li> Benjamini和Yekutieli开发的<b>错误发现率-BY</b>比其他方法功能更强大。</li>
    <li> <b>Scheffe</b>法是一种测试，用于在每个组的所有对比中寻找重要的对比。</li>
    <li> 如果实验组和对照组的大小不相等，则建议使用<b>Tukey Honest Significant Difference</b>。</li>
    <li> <b>Dunnett</b>有助于将所有治疗组与对照组进行比较。</li>
  "
    )
