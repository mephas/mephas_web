...
##########----------##########----------##########
tabPanel("单因素差分析(1-way)和多重比较",

headerPanel("单因素方差分析比较多组值和多重比较"),
conditionalPanel(
...
tabPanel("双因素方差分析(2-way)和多重比较",

headerPanel("双因素方差分析比较多组均值和多重比较"),
...
<h4><b> 1. 功能</b></h4>
<ul>
<li> 测定各因子组之间的均值是否有显著差异；</li>
<li> 测定因子组的均值是否存在显著差异，假设单向方差分析发现各组间存在显著差异。</li>
