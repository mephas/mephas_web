##----------------------------------------------------------------
##
## The univariate regression models: lm, logistic model, cox model, ui
## 
## DT: 2018-11-30
##
##----------------------------------------------------------------
...
mainPanel(
  ...
  h4(tags$b("Models")),
  tabsetPanel(
    tabPanel("Estimation", p(br()),
      actionButton("B1", "Submit after the display of formula"),
      p(br()),
      tags$b("1. Regression Fitting"),htmlOutput("fit"), p(br()),
      tags$b("2. ANOVA Table"), tableOutput("anova")
      ),
