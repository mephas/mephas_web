...
<h4><b> 1. 功能  </b></h4>
<ul>
<li> 检验数据来源的总体的中位数/位置在统计学上是否与指定的中位数有显著差异；</li>
<li> 有关数据的基本描述性统计信息；</li>
<li> 数据的描述性统计图，如箱形图、分布直方图及密度分布图。</li>
</ul>
...
HTML(
    ...
    "
<p>数据不能假定为正态分布时，这种方法是双样本T检验的替代方法。</p>

<h4><b> 1. 功能  </b></h4>
<ul>
<li> 测定2组数据来源的总体中位数在统计学上是否存在显著差异；</li>
<li> 测定2组数据的来源的分布位置是否不同；</li>
